          ...
          >
            ...
            <span className="flex justify-end">
              <Link
                ...
                className="flex items-center gap-2 bg-blue-600 text-white text-lg font-bold px-6 py-3 rounded-xl shadow hover:bg-blue-500 transition-colors duration-200"
              >
